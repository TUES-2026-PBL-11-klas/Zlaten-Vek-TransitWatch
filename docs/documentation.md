...
Съвременните градски транспортни системи генерират огромно количество ситуационна информация — закъснения, технически неизправности, претовареност, присъствие на контролни органи — която остава недостъпна за пътниците в момента, в който е най-необходима. Съществуващите механизми за обратна връзка са насочени предимно към административните звена и не предоставят канал за пряка комуникация между самите потребители на транспортната мрежа.

Настоящата разработка представя **TransitWatch Sofia** — уеб приложение за crowdsourced докладване на проблеми в градския транспорт на София в реално време. Системата позволява на регистрирани потребители да публикуват сигнали, категоризирани по вид и линия, които се визуализират незабавно върху интерактивна карта. Всеки сигнал има дефиниран жизнен цикъл — автоматично изтича след период, определен спрямо категорията му, без да е необходима ръчна намеса.

Проектът е реализиран от екип **Златен Век** в рамките на Единния проект за 11. клас в ТУЕС към ТУ-София. Документацията обхваща пълния процес: анализ на предметната област и съществуващите решения, функционални изисквания, архитектурно проектиране, техническа реализация, инфраструктура и тестване.
...
<p><strong>Диаграма 1 — Инфраструктурна диаграма</strong></p>

<iframe src="diagrams/infrastructure-diagram.html" width="100%" height="720" style="border:1px solid #E5E7EB; border-radius:8px;" title="Infrastructure Diagram"></iframe>

[Отвори диаграмата в отделен файл](diagrams/infrastructure-diagram.html)
...
<p><strong>Диаграма 2 — ER диаграма</strong></p>

<iframe src="diagrams/database-diagram.html" width="100%" height="820" style="border:1px solid #E5E7EB; border-radius:8px;" title="Database ER Diagram"></iframe>

[Отвори диаграмата в отделен файл](diagrams/database-diagram.html)
...
<p><strong>Диаграма 3 — UML Class диаграма</strong></p>

<iframe src="diagrams/uml-class-diagram.html" width="100%" height="820" style="border:1px solid #E5E7EB; border-radius:8px;" title="UML Class Diagram"></iframe>

[Отвори диаграмата в отделен файл](diagrams/uml-class-diagram.html)
